...
txicts <- txi$counts
pbmc <- CreateSeuratObject(counts = txicts, min.cells = 3, min.features = 200, project = "lava-lamp-project-4")
...
plot7 <-JackStrawPlot(pbmc, dims = 1:15)
...
###SAVE RDS###
#saveRDS(pbmc, file = "/projectnb2/bf528/users/lava-lamp/project-4-lava-lamp-1/analysis/output/panc.rds")
